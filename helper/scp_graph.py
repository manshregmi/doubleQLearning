...
# -----------------------------
def build_csp_graph_from_profiling(prof: ProfilingData, bw):
    """
    ...
    congesstion = (prof.numberOfEdgeDevice - 1) * np.random.uniform(0.5,1)
    ...
    for _ in range(len(layers)):
        ...
        bandwidth_changes.append(new_bandwidth)
...
if __name__ == "__main__":
    ...
    for _ in range(10000):
        ...
        G, last_layer_states = build_csp_graph_from_profiling(prof, bw)
