...
def run_a2c_simulation(profiling_data: ProfilingData, episodes=10000, max_steps=20, is_test=False, BW_bins=15, CT_bins=20, surplus_bins=25):
    """
    ...
    """
    # 1. Initialization
    agent = A2CAgent(profiling_data, is_test=is_test, BW_bins=BW_bins, CT_bins=CT_bins, surplus_bins=surplus_bins)
